                ...
                case GGML_OP_DIV:
                    {
                        ...
                        if (bcast_row) {
                            ...
                            const int nth = MIN((int) pipeline.maxTotalThreadsPerThreadgroup, (int)ne0);

                            if (nth > 0 && ne01 > 0 && ne02 > 0 && ne03 > 0)
                ...
                case GGML_OP_ACC:
                    {
                        ...
                        if (!inplace) {
                            ...
                            const int nth = MIN((int) pipeline.maxTotalThreadsPerThreadgroup, (int)ne00);
