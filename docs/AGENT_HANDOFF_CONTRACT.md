...
For Voxema, this format is for actual delegation and explicitly selected structured integrations. Local role changes and user-facing answers do not require JSON. `AGENTS.md` governs authorization, rigor, and completion.
