...
For Voxema, `AGENTS.md` defines a portable execution policy. The runtime supplies real tools and permissions; these markdown files supply methods, not a scheduler or enforced security boundary.
